...
module Recaptcha
  module Verify
    ...
    #   (see {Recaptcha::Verify::VerifyResult}).
    ...
    #
    # @return [Recaptcha::Verify::VerifyResult, Boolean] The result of verification, including the `score`.
    #   or `error_codes`.
    ...
    # @return [Recaptcha::Verify::VerifyResult, Boolean] The result of verification as a
    # VerifyResult for v3, or as a boolean for v2.
    def _verify_recaptcha(version, response_token, options = {})
      ...
      begin
        ...
        if result.valid?
          ...
          result_or_boolean.(result, false)
        end
