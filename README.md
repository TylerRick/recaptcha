...
| v2 Checkbox<br/>("I'm not a robot" Checkbox) | [`recaptcha_tags`](#recaptcha_v2_checkbox-recaptcha_tags)<br/>                     [`verify_recaptcha_v2`](#verify_recaptcha-verify_recaptcha_v2) | Verify requests with a challenge: Validate requests with the "I'm not a robot" checkbox |
| v2 Invisible<br/>(Invisible reCAPTCHA badge) | [`invisible_recaptcha_tags`](#recaptcha_v2_invisible-invisible_recaptcha_tags),<br/>[`verify_recaptcha_v2`](#verify_recaptcha-verify_recaptcha_v2) | Verify requests with a challenge: Validate requests in the background |
...
### [`verify_recaptcha`](https://www.rubydoc.info/github/ambethia/recaptcha/master/Recaptcha/Verify#verify_recaptcha_v2-instance_method) (`verify_recaptcha_v2`)
...
You can also use one of the variants, `verify_recaptcha_v2_checkbox` and
`verify_recaptcha_v2_invisible`, if you are using a mix of v2 checkbox, invisible, and v3 in your
frontend and want it to automatically use the corresponding correct key in the backend.
...
1. reCAPTCHA v3 is invisible and will never interrupt your users; if you want a visible UI, you have
   to build one yourself (or show a v2 challenge if the score from v3 falls below the threshold that
   you choose).
...
[`verify_recaptcha_v3`](#verify_recaptcha_v3) in order to get the [score](https://developers.google.com/recaptcha/docs/v3#score).
